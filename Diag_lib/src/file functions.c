...
void ticks_to_inches(int target_mav_speed, double distance){
    ...
    char line8[16];
    while(fgets(line8, sizeof(line8),file995))


    {printf("%s is clicker\n", line8);}
    fclose(file995);
    int clicker=atof(line8);
...
int IR_Ports()
{
    ...
    int et;
    printf("Select the front left sensor\n a=0\n b=1\n c=2\n x=3\n y=4\n z=5");
    ...
    msleep(1500);
    display_clear();
    printf("Select the back left sensor\n a=0\n b=1\n c=2\n x=3\n y=4\n z=5");
    ...
    msleep(1500);
    display_clear();
    printf("Select the front right sensor\n a=0\n b=1\n c=2\n x=3\n y=4\n z=5");
    FILE * file8 = fopen("ITLb.txt", "w"); 
    fprintf(file8, "%d", ITLb);
    fclose(file8);
    while(1)
    {
        if(side_button() == 1)
    ...
    msleep(1500);
    FILE * file7 = fopen("ITRb.txt", "w"); 
    fprintf(file7, "%d", ITRb);
    fclose(file7);
...
int wandbval()
{
    ...
    FILE *file8= fopen ("ITLb.txt","r");
    char line3[16];
    while(fgets(line3, sizeof(line),file8)){}
    double itlb=atof(line3);
    int ITLb = itlb *1;
    ...
    FILE *file7= fopen ("ITRb.txt","r");
    char line5[16];
    while(fgets(line5, sizeof(line5),file7)){}

    msleep(5);
    fclose(file7);
    double it1b=atof(line0);
    int ITRb = it1b;
    ...
    */
    ...
    while(1)
    {
        while(side_button() == 1)
        {
            ...
            itrw = analog(ITR);
            itlw = analog(ITL);
            int itrbw = analog(ITRb);
            int itlbw = analog(ITLb);
            printf("\n front right white value is %d",itrw);
            printf("\n front left white value is %d",itlw );
            printf("\n back right white value is %d",itrbw);
            printf("\n back left white value is %d",itlbw );
            number  = 5;
        }
        if(number == 5)
        {
    ...
    while(1)
    {
        ...
        while(side_button() == 1)
        {
            ...
            int itrb = analog(ITR);
            int itlb = analog(ITL);
            int itrbb = analog(ITRb);
            int itlbb = analog(ITLb);
            
            printf("\n front right black value is %d",itrb);
            printf("\n front left black value is %d",itlb);
             printf("\n back right black value is %d",itrbb);
            printf("\n back left black value is %d",itlbb);
            ...
            int rbmidpoint = itrw+itrb;
            rmidpoint = rmidpoint/2;

            int lbmidpoint = itlw+itlb;
            lbmidpoint = lbmidpoint/2;
            ...
            FILE * file38 = fopen("lbmidpoint", "w"); 
            fprintf(file38, "%d", lbmidpoint);
            msleep(5);
            fclose(file38);
            
             FILE * file37 = fopen("rbmidpoint", "w"); 
            fprintf(file37, "%d", rbmidpoint);
            msleep(5);
            fclose(file37);
